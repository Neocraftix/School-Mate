...
@section('title', 'School Mate | Student Report Generator')
    ...
    <body>
        ...
        <div class="container">
            ...
            <div class="page-header">
                <div class="header-content">
                    ...
                    <div class="header-text">
                        ...
                        <p>Generate comprehensive student reports with advanced filtering</p>
                    </div>
                </div>
            </div>
            ...
            <div class="filter-section">
                <form method="POST" action="{{ route('students.studentGanarateReportFilter') }}">
                    @csrf
                    ...
                    <div class="filters-grid">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-input" id="admissionNumber" name="admissionNumber"
                                value="" placeholder="Enter admission number">
                        </div>

                        <div class="form-group">
                            <label class="form-label">👤 Child Name</label>
                            <input type="text" class="form-input" id="childName" name="childName" value=""
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-select" id="transport" name="transport">
                                ...
                                @foreach ($transports as $transport)
                                    <option value="{{ $transport->id }}">{{ $transport->transport_methord }}</option>
                                @endforeach
                            </select>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-select" id="specialSkills" name="specialSkills">
                        ...
                        <div class="form-group">
                            <label class="form-label">🏛️ Government Assistance</label>
                            <select class="form-select" id="govAssistance" name="govAssistance">
                                <option value="">All</option>
                                @foreach ($assistances as $assistance)
                                    <option value="{{ $assistance->id }}">{{ $assistance->assistance }}</option>
                                @endforeach
                            </select>
                        </div>
            ...
            <div class="results-section active" id="resultsSection">
                <div class="results-header">
                    {{-- <div class="results-count">
                        Found <span id="resultCount">0</span> students
                    </div> --}}
                ...
                <div class="empty-state" id="emptyState">
                    ...
                    <div class="empty-text">No students found matching your criteria</div>
                </div> --}}
                        ...
                        <tbody id="tableBody">
                            @foreach ($students as $student)
                                <tr>
                                    ...
                                    <td><span class="badge">{{ $student->gender->gender }}</span></td>
                                    <td>Grade {{ $student->grade->grade }}</td>
                                    <td>{{ $student->bloodType->blood_type }}</td>
                                    <td><span class="badge">{{ $student->transport->transport_methord }}</span></td>
                                    <td>{{ $student->skill->skill }}</td>
                                    <td><span>{{ $student->assistance->assistance }}</span></td>
                                    <td><span>{{ $student->studentStatus->student_status }}</span></td>
                                </tr>
                            @endforeach
                        </tbody>
                    </table>
