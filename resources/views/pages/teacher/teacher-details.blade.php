...
@section('title', 'School Mate | teacher Details')
                    ...
                    <div class="profile-avatar-section">
                        ...
                        @else
                            <div class="profile-status offline">
                                <span class="status-dot"></span>
                                {{ $teacher->teacherStatus->name }} Teacher
                            </div>
                        @endif

                    </div>
                    <div class="profile-info">
                        <h1 class="student-name">{{ $teacher->full_name }}</h1>
                        <p class="student-tagline">Email : {{ $teacher->email }}</p>
                        <div class="student-meta">
                            ...
                            <span class="meta-item">
                                <span class="meta-icon">📅</span>
                                Joined : {{ $teacher->created_at->format('d F Y') }}
                            </span>
                            <span class="meta-item">
                                @php
                                    $dob = $teacher->dob;
                ...
                <div id="basic-info" class="tab-pane active">
                    <div class="info-grid">
                        <div class="info-card personal">
                            ...
                            <div class="info-list">
                                <div class="info-item">
                                    ...
                                    <span class="info-value">{{ $teacher->title->name }}</span>
                                </div>
                                <div class="info-item">
                                ...
                                <div class="info-item">
                                    ...
                                    <span class="info-value">{{ $teacher->name_with_initials }}</span>
                                </div>
                                <div class="info-item">
                                    <span class="info-label">N.I.C:</span>
                                    <span class="info-value">{{ $teacher->nic }}</span>
                                </div>
                                <div class="info-item">
                                    <span class="info-label">Date of Birth:</span>
                                    <span class="info-value">{{ $teacher->dob }}</span>
                                </div>
                                <div class="info-item">
                                    <span class="info-label">Ethnicity:</span>
                                    <span class="info-value">{{ $teacher->ethnicity->name }}</span>
                                </div>
                                <div class="info-item">
                                    <span class="info-label">Gender:</span>
                                    <span class="info-value">{{ $teacher->gender->gender }}</span>
                                </div>
                                <div class="info-item">
                                    <span class="info-label">Religion:</span>
                                    <span class="info-value">{{ $teacher->religion->name }}</span>
                                </div>
                                <div class="info-item">
                                ...
                                <div class="info-item">
                                    ...
                                    <span class="info-value">{{ $teacher->district->zone_name }}</span>
                                </div>

                                <div class="info-item">
                                    <span class="info-label">DS Division:</span>
                                    <span class="info-value">{{ $teacher->ds_division }}</span>
                                </div>
                                <div class="info-item">
                                    <span class="info-label">GS Division:</span>
                                    <span class="info-value">{{ $teacher->gs_division }}</span>
                                </div>
                        ...
                        <div class="info-card contact">
                            ...
                            <div class="info-list">
                                <div class="info-item">
                                    ...
                                    <span class="info-value">{{ $teacher->civilStatus->name }}</span>
                                </div>
                                <div class="info-item">
                                    <span class="info-label">Name of Spouse:</span>
                                    <span class="info-value">{{ $teacher->spouse_name ?? 'No Spouse' }}</span>
                                </div>

                                <div class="info-item">
                                    <span class="info-label">Names of the Children:</span>
                                    <span class="info-value">{{ $teacher->children_names ?? 'No Children' }}</span>
                                </div>

                                <div class="info-item">
                                    <span class="info-label">Birth of Date of the Children:</span>
                                    <span class="info-value">{{ $teacher->children_dobs ?? 'No Children' }}</span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="info-card guardian">
                            ...
                            <div class="info-list">
                                <div class="info-item">
                                    <span class="info-label">NCOE:</span>
                                    <span class="info-value">{{ $teacher->ncoe ?? '' }}</span>
                                </div>
                                <div class="info-item">
                                    <span class="info-label">Degree:</span>
                                    <span class="info-value">{{ $teacher->degree ?? '' }}</span>
                                </div>
                                <div class="info-item">
                                    <span class="info-label">AL:</span>
                                    <span class="info-value">{{ $teacher->al ?? '' }}</span>
                                </div>
                                <div class="info-item">
                                    <span class="info-label">Diploma:</span>
                                    <span class="info-value">{{ $teacher->diploma ?? '' }}</span>
                                </div>
                                <div class="info-item">
